...
from db import items_col, users_col, exchanges_col  # <-- add exchanges_col
...
class Exchange:
    ...
    def create_exchange(user1_id, user2_id, item1_id, item2_id, status="pending"):
        ...
        try:
            ...
            result = exchanges_col.insert_one(exchange)  # changed
    ...
    def get_user_exchanges(user_id):
        ...
        try:
            ...
            for exchange in exchanges:
                ...
                item2 = items_col.find_one({"_id": ObjectId(exchange["item2_id"])})  # fixed
    ...
    def update_exchange_status(exchange_id, status):
        ...
        try:
            ...
            result = exchanges_col.update_one(  # changed
    ...
    def get_exchange_by_id(exchange_id):
        ...
        try:
            exchange = exchanges_col.find_one({"_id": ObjectId(exchange_id)})  # changed
            if exchange:
                exchange["_id"] = str(exchange["_id"])
                exchange["user1_id"] = str(exchange["user1_id"])
                exchange["user2_id"] = str(exchange["user2_id"])
